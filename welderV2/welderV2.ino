        ...
        while(inputStatus==0)//Mode==============
           {
             ...
             if(inKey=='A'){  
                ...
                lcd.clear();lcd.print("??"); time1=0;time2=0;mode=0;
                inputStatus=0;
                Stringkey="";
                break;
              }
             ...
             if((inKey=='0')or(inKey=='1')or(inKey=='2')or(inKey=='3')or(inKey=='4')or(inKey=='5')or(inKey=='6')or(inKey=='7')or(inKey=='8')or(inKey=='9')){
               ...
               lcd.setCursor(0,1);lcd.print(Stringkey);
             }
           }
        ...
        while(inputStatus==1)//Time1============
           {
             ...
             if(inKey=='A'){
                lcd.clear();lcd.print("Reset");delay(500);
                lcd.clear();lcd.print("??");
                time1=0;time2=0;mode=0;inputStatus=0;Stringkey="";
                break;
             }
             
             if(inKey=='B'){

                time1=Stringkey.toInt();
                inputStatus=2;
        ...
        while(inputStatus==2)//Time2================
           {
             ...
             if(inKey=='A'){
               lcd.clear();lcd.print("Reset");delay(500);
               lcd.clear();lcd.print("??"); time1=0;time2=0;mode=0;inputStatus=0;Stringkey="";
               break;
              }
               
              if(inKey=='B'){
                time2=Stringkey.toInt();
                inputStatus=3;
            ...
            while(inputStatus=4)
                {
                  ...
                  if(inKey=='A'){
                    lcd.clear();lcd.print("Reset");delay(500);lcd.clear();lcd.print("??"); 
                    time1=0;time2=0;
                    mode=0;
                    inputStatus=0;
                    Stringkey="";
                  ...
                  if(inKey=='B'){
                    lcd.clear();lcd.print("..Again");delay(2000);lcd.clear();
                    inputStatus=3;
                    break;
                  }
                }
